...
<body>
	<div id="main">
        ...
        <div id="log">
			<form id="loginForm" method="post" action="<%=path %>/ReplyMessagServlet">
			<input type="hidden" name="post_user_id" value="<%=current_user_info.getUser_id()%>"/>
			...
			<div id="cmopd">
				<ul>
					...
					<li><strong class="lts">回复：</strong>
					<script id="editor" type="text/plain" style="width:486px;height:200px;"></script>
					</li>
				</ul>
			</div>
			<div id="cfopd">
				<input type="button" class="btn_sub" value="回复留言" onclick="check_post_msg_valid()"/>
